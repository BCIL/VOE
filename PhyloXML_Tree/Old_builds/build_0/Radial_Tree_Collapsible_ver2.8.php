...
<?php
        ...
        && ($_FILES["file"]["size"] < 1000000)   // file size limit: 1000 kb
        && in_array($extension, $allowedExts)) {
            if ($_FILES["file"]["error"] > 0) {
                echo "Error: " . $_FILES["file"]["error"] . "<br>";
            } else {
                echo "<h3> -- Detail of the file -- <h4><ul>";
                echo "<li>Uploaded: " . $_FILES["file"]["name"] . "</li><br>";
                echo "<li>Type: " . $_FILES["file"]["type"] . "</li><br>";
                echo "<li>Size: " . ($_FILES["file"]["size"] / 1024) . " kB</li><br>";
                ...
                if (file_exists("upload/" . $_FILES["file"]["name"])) {
                    ...
                    echo "<li>Stored in: " . "upload/" . $_FILES["file"]["name"] . "</li></ul><br>";
                }
            }
        } else {
            echo "Invalid file";
        ...
        echo "<strong>Press "."<a href=\"javascript:history.go(-1)\"> GO BACK </a>"."to move previous page </strong>";
?>


        <h1 id="title"> Collapsible radial tree </h1>
        ...
        var filePath = "/xml_to_json_Parser/pythonUploader/uploaded/" + data + ".json";;
        ...
        {    
            ...
            */
            ...
            function update(source) {
                ...
                var nodeCircle = nodeEnter.append("circle")
                    ...
                    .attr("r", function(d) {
                        ...
                        else if (d.property.text === parseFloat(d.property.text))
                        {
                            if (isInt(d.property.text)) { return setNodeSize_default }
                            else if (d.property.text < nsDivider * setNodeSize_min) { return setNodeSize_min;}
                        }
                        else { return setNodeSize_default }
                        /*
                        if (d.property == null) { return setNodeSize_default }
                        else if (d.property.text < nsDivider * setNodeSize_min) { return setNodeSize_min;}
                    ...
                    .on("mouseover", function(d) {
                        ...
                        .attr("r", function(d) {
                            ...
                            { return (d.property.text / nsDivider) + 4 }
                            else { return setNodeSize_default }
                        })
                    })
                    ...
                    .on("mouseout", function(d) {
                        ...
                        .attr("r", function(d) {
                            ...
                            {
                                if (d.property.text < nsDivider * setNodeSize_min) { return setNodeSize_min;}
                                else { return d.property.text / nsDivider}
                            }
                            else { return setNodeSize_default }
                            })
            ...
            jsonData.children.forEach(collapseAll);
